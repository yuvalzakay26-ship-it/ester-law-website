...
export default function Services() {
    ...
    return (
        <section id="services" aria-labelledby="services-title" className="py-24 bg-neutral-50 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 transition-opacity duration-700">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 id="services-title" className="text-3xl md:text-5xl font-bold text-primary mb-6">
                        {services.title}
                    </h2>
                ...
                <div className="text-center">
                    <p className="text-neutral-500 mb-6 font-medium">{services.bottomLead}</p>
                    <button
                        onClick={scrollToContact}
                        className="inline-flex items-center gap-2 text-primary font-bold border-b-2 border-accent hover:text-accent hover:border-primary transition-all pb-0.5 group focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
                    >
